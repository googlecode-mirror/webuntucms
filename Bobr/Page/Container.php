 ...
 * @author rbas
 */
class Bobr_Page_Container extends Bobr_Colection
{
    ...
    public function __construct($id = 0)
    {
        ...
        $this->setColectionClass('Bobr_Page_Block');
     ...
     * @throws Bobr_Page_ContainerException Pokud neexistuje ani jeden z blcku.
     * @return Bobr_Page_Container
     */
    public function loadBlockByIds($blockIds)
    {
        ...
        if (empty($record)) {
            throw new Bobr_Page_ContainerException('Blocky ' . $blockIds . ' neexistuji.');
        }
     ...
     * @throws Bobr_Page_ContainerException Pokud nenajde zadne data.
     * @return Bobr_Page_Container
     */
    public function loadContainer()
    {
        if (0 > $this->Id) {
                throw new Bobr_Page_ContainerIAException('Neni zadano id kontejneru ktery se ma nacist.');
        }
        ...
        if (empty($record)) {
            throw new Bobr_Page_ContainerException('Container id ' . $this->id . ' neexistuje.');
        }
