 ...
 * @author rbas
 */
abstract class Bobr_Colection extends Bobr_DataObject implements Countable, Iterator, ArrayAccess
{
    /**
    ...
    public function importColection(array $record)
    {
        ...
        } catch (Bobr_DataObjectIAException $e) {
            throw new Bobr_ColectionException('Ve tride ' . $this->getClass() . ' nastala chyba: ' . $e->getMessage());
        }
