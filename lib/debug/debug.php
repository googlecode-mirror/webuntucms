 ...
 * @category   Nette
 * @package    Nette
 * @version    $Id: Debug.php 35 2008-07-17 11:36:16Z David Grudl $
 */
...
final class Debug
{
	...
	public static function enable($level = E_ALL, $logErrors = NULL, $sendEmails = FALSE)
	{
		...
		set_error_handler(array(__CLASS__, 'errorHandler'), E_ALL | E_NOTICE | E_STRICT );
		self::$enabled = TRUE;
	}
	...
	{
		$colophons = self::$colophons;
		require __WEB_ROOT__ . '/lib/debug/debug.templates/profiler.phtml';
	}
