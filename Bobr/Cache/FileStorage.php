<?php
/**
 * Description of Bobr_Cache_FileStorage
 *
 * @author rbas
 */
class Bobr_Cache_FileStorage extends Object implements Bobr_Cache_CacheAdapterInterface
{
    /**
