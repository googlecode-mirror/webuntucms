 ...
 * @author rbas
 */
class Bobr_Page_PageId extends Bobr_DataObject
{
    ...
    private function load()
    {
        if (!$this->loadFromCache()) {
            ...
            if (0 > $this->id) {
                throw new Bobr_Page_PageIdIAException('Neni zadano id pro PageId. Nemuze se nacist.');
            }
            ...
            if (empty($record)) {
                throw new Bobr_Page_PageIdException('PageId ' . $this->id . ' neexistuje.');
            }
